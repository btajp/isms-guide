...
### Phase 3.5: テンプレート拡充（全93管理策対応）

現在、一部の管理策にはテンプレートが存在していません。テンプレートはサンプルとしての役割も持つため、「こういったことを定める必要がある」というイメージを利用者に伝える目的で、**全93管理策に対応するテンプレートを作成する必要があります**。

#### 課題: 仮想的な組織の設定

物理的セキュリティなど組織固有の内容が多い管理策については、テンプレート作成にあたり**仮想的な組織を設定**する必要があります。

**検討事項:**
- 組織規模（従業員数、拠点数）
- 業種（IT企業、製造業、サービス業など）
- オフィス形態（自社ビル、賃貸オフィス、リモートワーク中心など）
- 扱う情報の種類（個人情報、営業秘密、技術情報など）

#### テンプレート未作成の管理策一覧

| カテゴリ | 管理策ID | 管理策名 | 必要なテンプレート |
|----------|----------|----------|-------------------|
| 組織的管理策 | A.5.5 | 関係当局との連絡 | 連絡先一覧・連絡手順 |
| 組織的管理策 | A.5.6 | 専門組織との連絡 | 専門組織一覧・連絡手順 |
| 組織的管理策 | A.5.7 | 脅威インテリジェンス | 脅威情報収集・分析手順 |
| 組織的管理策 | A.5.8 | プロジェクトマネジメント | プロジェクトセキュリティガイドライン |
| 組織的管理策 | A.5.33 | 記録の保護 | 記録管理手順・保管ルール |
| 組織的管理策 | A.5.37 | 操作手順書 | 操作手順書テンプレート |
| 人的管理策 | A.6.1 | 選考 | 採用時セキュリティチェック手順 |
| 物理的管理策 | A.7.1 | 物理的セキュリティ境界 | 物理的セキュリティ方針 |
| 物理的管理策 | A.7.2 | 物理的入退 | 入退室管理手順 |
| 物理的管理策 | A.7.3 | オフィス、部屋及び施設のセキュリティ | 施設セキュリティガイドライン |
| 物理的管理策 | A.7.4 | 物理的セキュリティの監視 | 監視・巡回手順 |
| 物理的管理策 | A.7.6 | セキュリティを保つべき領域での作業 | セキュリティエリア作業規則 |
| 物理的管理策 | A.7.8 | 装置の設置及び保護 | 装置設置・保護基準 |
| 物理的管理策 | A.7.12 | ケーブル配線のセキュリティ | ケーブル配線基準 |
| 物理的管理策 | A.7.13 | 装置の保守 | 保守管理手順 |
| 物理的管理策 | A.7.14 | 装置のセキュリティを保った処分又は再利用 | 装置廃棄・再利用手順 |

| タスク | 説明 | 状態 |
|--------|------|------|
| 仮想組織の設定 | テンプレート作成のための想定組織を定義 | 未着手 |
| 物理的管理策テンプレート | A.7.1-A.7.4, A.7.6, A.7.8, A.7.12-A.7.14 のテンプレート作成 | 未着手 |
| 組織的管理策テンプレート | A.5.5-A.5.8, A.5.33, A.5.37 のテンプレート作成 | 未着手 |
| 人的管理策テンプレート | A.6.1 のテンプレート作成 | 未着手 |
| リンク整備 | controls/index.md, 適用宣言書へのアンカーリンク追加 | 未着手 |
...
| 2026-01-26 | controls/index.md, 適用宣言書へのアンカーリンク追加 |
| 2026-01-26 | Phase 3.5（テンプレート拡充）計画を追加 |
